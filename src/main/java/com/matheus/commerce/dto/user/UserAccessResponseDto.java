...
public record UserAccessResponseDto(String id, String name, String lastName, String birthDate, String email, Role role, String cpf, Set<OrderResponseDto> orders, String accessToken) {
    public UserAccessResponseDto(User user, Set<OrderResponseDto> responseOrder,String accessToken) {
        this(user.getId(), user.getName(), user.getLastName(), user.getBirthDate(), user.getEmail(), user.getRole(), user.getCpf(), responseOrder,accessToken);
    }
