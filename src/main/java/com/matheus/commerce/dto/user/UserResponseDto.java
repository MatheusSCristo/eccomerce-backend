...
public record UserResponseDto(String id, String name, String lastName, String birthDate, String email, Role role, String cpf, Set<OrderResponseDto> orders) {
    public UserResponseDto(User user, Set<OrderResponseDto> responseOrder) {
        this(user.getId(), user.getName(), user.getLastName(), user.getBirthDate(), user.getEmail(), user.getRole(), user.getCpf(), responseOrder);
    }
