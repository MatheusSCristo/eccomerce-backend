...
O [ShopPlus](https://shopplus-pi.vercel.app/) é um site de e-commerce de tênis

Recursos disponíveis para acesso via API:
* [**Produtos**](#reference/recursos/produtos)
* [**Compras**](#reference/recursos/compras).
* [**Usuários**](#reference/recursos/usuarios)
* [**Autenticação**](#reference/recursos/autenticação)
* [**Pagamento**](#reference/recursos/pagamento)
* [**Email**](#reference/recursos/email)
* [**Admin**](#reference/recursos/email)
...
| Método | Descrição |
|---|---|
| `GET` | Apenas retorna informações de um ou mais registros. |
| `POST` | Utilizado para criar um novo registro e retornar informações desse registro. |
...
Nosso backend utiliza [JWT](https://jwt.io/) como forma de autenticação/autorização .
...
+ Request (application/json)
  + Headers
            Authorization: Acesso liberado!
+ Response 200 (application/json)
           {
                "id": "44ab3215-8921-4db6-9cDf-29fdc0c6bbd0",
        "name": "Tênis Nike Downshifter 12 Masculino - Azul",
        ...
        "ratings": [
            {
                "rating": 3,
                "comment": "Não é tão bom quanto o esperado, mas faz jus ao preço.",
                "userId": "0283-4MASD912-DNM19ASJD-123AS",
                "orderProductId": "028A3-4MASDD912-DNMFF19ASJD-123AS",
                "productId": "44ab3215-8921-4db6-9cDf-29fdc0c6bbd0"
            }
        ],
        "brand": "Nike",
